!function(t, e) {
    ...
    , function(t, e, n) {
        ...
        e.getButtonListOpts = function(t) {
            ...
            return "string" == typeof t ? n[e.CONFIRM_KEY] = l(e.CONFIRM_KEY, t) : Array.isArray(t) ? n = u(t) : o.isPlainObject(t) ? n = c(t) : !0 === t ? n = u([!0, !0]) : !1 === t ? n = u([!1, !1]) : void 0 === t && (n = e.defaultButtonList),
            n
        }
    }
    , function(t, e, n) {
    ...
    , function(t, e, n) {
        ...
        e.setActionValue = function(t) {
            if ("string" == typeof t)
                return i(o.CONFIRM_KEY, t);
            for (var e in t)
                i(e, t[e])
        }
        ;
        var i = function(t, e) {
            a.actions[t] || (a.actions[t] = {}),
    ...
    , function(t, e, n) {
        ...
        ;
        var d = function() {
            o.getNode(i).classList.remove(s),
            u.default.isOpen = !1
        };
        ...
        t.exports = function(t) {
            ...
            return t.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(t, e) {
                ...
                if (/^(#|data:|http:\/\/|https:\/\/|file:\/\/\/)/i.test(r))
                    return t;
                var a;
                return a = 0 === r.indexOf("//") ? r : 0 === r.indexOf("/") ? n + r : o + r.replace(/^\.\//, ""),
    ...
    , function(t, e, n) {
        ...
        s.setActionValue = a.setActionValue,
    ...
    , function(t, e, n) {
        ...
        var o = n(5)
          ...
          , m = function(t) {
            if (o.default.isOpen)
                return "Tab" === t.key && t.shiftKey ? f(t) : void 0
        }
          , g = function() {
            var t = a.getNode(c);
            t && (t.tabIndex = 0,
          ...
          , y = function(t) {
            if (a.getNode(u) === t.target)
                return r.onAction(i.CANCEL_KEY)
        }
          , k = function(t) {
            var e = a.getNode(u);
            e.removeEventListener("click", y),
            t && e.addEventListener("click", y)
        }
          , O = function(t) {
    ...
    , function(t, e, n) {
        ...
        e.getOpts = function() {
            ...
            var o = l(n);
            return n.buttons = r.getButtonListOpts(o),
            delete n.button,
